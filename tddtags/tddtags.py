# -*- coding: utf-8 -*-
"""
:unit_test_module: test_tddtagsX
...
class Formatter(object):
    ...
    def gen_class_def(self, out_file, class_name, description='', parent_name='TestCase'):
        ...
        if tddtags_config['generate_setup_method']:
            ...
            out_file.write('        %s', tddtags_config['setup_method_body'])

        if tddtags_config['generate_teardown_method']:
            out_file.write('    %s\n', tddtags_config['teardown_method_def'])
            out_file.write('        %s', tddtags_config['teardown_method_body'])
        else:
            out_file.write('    pass\n')
...
class ModuleUpdater(object):
    ...
    """
    def __init__(self, ut_module, loaded_module):
        """
        :unit_test: create_instance
        """
    ...
    def update(self, module_path):
        ...
        # Any new classes?
        existing_classes = dict(inspect.getmembers(self.loaded_module, inspect.isclass))
        ...
        container = self._check_existing_classes(container, module_path, existing_classes=existing_classes)
    ...
    def _check_existing_classes(self, container, module_path, existing_classes):
        ...
        :unit_test: check_existing_classes
        :unit_test: check_existing_classes_none
        """
...
class TDDTag(object):
    ...
    def run(self, module_name, class_filter=None, verbose=False):
        ...
        """
        print "\TDDTag - scanning source to generate/update unit test skeletons"
...
def create_module_loader(with_doc_tags=False, script_path=sys.argv[0]):
    """
